...
public class DetailsApi {
     ...
     * updated_at : 2020-11-26T00:11:17Z
     */
    ...
    public static DetailsApi objectFromData(String str) {

        return new Gson().fromJson(str, DetailsApi.class);
    }

    public static DetailsApi objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), DetailsApi.class);
    ...
    public static List<DetailsApi> arrayDetailsApiFromData(String str) {

        Type listType = new TypeToken<ArrayList<DetailsApi>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<DetailsApi> arrayDetailsApiFromData(String str, String key) {
